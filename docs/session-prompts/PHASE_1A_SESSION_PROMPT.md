...
You are working in the Sleep Paralysis Companion repository. This session is exclusively for **Phase 1A: Repository and platform foundation**. Treat this prompt as the session's operating contract. Do not assume access to earlier chat.
