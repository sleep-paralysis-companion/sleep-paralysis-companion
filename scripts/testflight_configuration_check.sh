...
grep -Fq '<string>AppStore app.sleepcompanion.spc</string>' "$EXPORT_OPTIONS"
grep -Fq '<key>app.sleepcompanion.spc.widget</key>' "$EXPORT_OPTIONS"
grep -Fq '<string>AppStore app.sleepcompanion.spc.widget</string>' "$EXPORT_OPTIONS"
grep -Fq '<string>app-store-connect</string>' "$EXPORT_OPTIONS"
grep -Fq 'PROVISIONING_PROFILE_SPECIFIER: "AppStore app.sleepcompanion.spc"' "$PROJECT_SPEC"
grep -Fq 'PROVISIONING_PROFILE_SPECIFIER: "AppStore app.sleepcompanion.spc.widget"' "$PROJECT_SPEC"
