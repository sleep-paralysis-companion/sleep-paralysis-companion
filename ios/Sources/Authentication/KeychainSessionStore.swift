...
/// 1. `SupabaseKeychainLocalStorage`: Bridges `supabase-swift`'s `AuthLocalStorage`
///    to iOS Keychain, acting as the sole persistent repository for access and refresh
///    tokens at rest.
/// 2. `KeychainSessionStore`: Stores the non-secret `AuthenticationIdentityRecord`
///    used by the app for cold-launch restore decisions, wrong-account validations,
///    and data-rights flows.
/// 3. `SystemKeychainClient`: Hardware-backed Keychain operations enforcing
