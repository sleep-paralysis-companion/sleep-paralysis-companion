    ...
    static let bundled = CatalogAudioManifest(
        ...
        assets: [
            ...
            CatalogAudioAsset(
                ...
                title: "Second Sleep",
                shortDescription: "A compact session for returning to rest after waking.",
                localeIdentifier: "en",
                delivery: .bundled,
                status: .approved,
                durationMilliseconds: 360_048,
                byteCount: 8_564_581,
                mimeType: "audio/mp4",
                codec: "aac-lc",
                sampleRateHz: 44100,
                channels: 2,
                sha256: "55afb320f05df055a95d150d9254a9cb807ed587bcf21ec242dd87ea2c9b4798",
                previewPathID: nil,
                downloadPathID: nil,
                offlineCacheAllowed: false,
                bundledResourceName: "spc_catalog_second-sleep_v1.m4a",
                minimumAppVersion: "1.0.0",
                minimumCatalogSchema: 1,
                provenanceReference: "audio-owner-supplied-2026-08-17",
                rightsReference: "owner-authorized-app-store-worldwide-offline-transcode-2026-08-17",
